typedef ValidFields = ({String string, String payload});

typedef InvalidFields = ({String string, String exception});

typedef TestStruct = ({List<ValidFields> valid, List<InvalidFields> invalid});

final TestStruct vectors = (
  valid: [
    (
  ...
  invalid: [
    ...
    (string: "#####", exception: "Non-base58 character"),
  ],
);
